...
def parse_args():
    ...
    parser.add_argument('--input_path', type=str, default=None, 
                        help='Root path containing dataset folders (默认: <repo>/datasets)')
    parser.add_argument('--output_path', type=str, default=None,
                        help='Root path to save processed data (默认: <repo>/datasets)')
    ...
    if not args.input_path:
        args.input_path = str(repo_root / 'datasets')
    if not args.output_path:
        args.output_path = str(repo_root / 'datasets')
    return args
